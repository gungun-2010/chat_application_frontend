...
import { Link } from "react-router-dom"; // 1. Fixed: Added missing Link import
...
const Navbar = () => {
  ...
  return (
     <>
     <header className="fixed top-0 w-full z-40 bg-white/80 backdrop-blur-lg border border-gray-200
     shadow-sm">
